...
def generate_pocket(data_dir,data_df, distance=8):
    ...
    for cid in complex_id:
        print(cid)
        save_path = './data/test2013'
        complex_dir = os.path.join(save_path, cid)
        ...
        lig_native_path = os.path.join(data_dir, f'{cid}', f'{cid}_ligand.sdf')
        protein_path = os.path.join(data_dir, f'{cid}', f'{cid}_protein.pdb')
...
def generate_complex_v1(data_dir, data_df, distance=8, input_ligand_format='sdf'):
    ...
    for i, row in data_df.iterrows():
        ...
        if input_ligand_format != 'pdb':
            ...
            ligand_input_path = os.path.join(data_dir, f'{cid}', f'{cid}_ligand.{input_ligand_format}')
