...
if __name__ == '__main__':
    ...
    for repeat in range(repeats):
        ...
        test2013_set = GraphDataset('./data/test2013', test2013_df, graph_type=graph_type,dis_threshold=8, create=False)
        ...
        test2013_loader = PLIDataLoader(test2013_set, batch_size=batch_size, shuffle=False, num_workers=8)
        ...
        load_model_dict(model, f'./model/20230817_110144_ConBAP_repeat3/model/contrastive_1.pt')
        ...
        valid_rmse, valid_pr = val(model, valid_loader, device)
        test2016_rmse, test2016_pr = val(model, test2013_loader, device)


        msg = "valid_rmse-%.4f, valid_pr-%.4f, test2013_rmse-%.4f, test2013_pr-%.4f," \
