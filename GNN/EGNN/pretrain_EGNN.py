...
from predataset_EGNN import PreGraphDatasetD,PreGraphDatasetV
...
if __name__ == '__main__':
    ...
    for repeat in range(repeats):
        ...
        train_set.data_name = train_set.data_name[:10000]
        ...
        model = EGNN(35, 256, 1, n_layers=3, normalize=True).cuda()
        ...
        for epoch in range(epochs):
            ...
            running_loss.reset()
            # start validating
            valid_rmse, valid_pr = val(model,model, valid_loader, 'cuda0')
        ...
        device = 'cuda'
        valid_rmse, valid_pr = val(model,model, valid_loader, device)
