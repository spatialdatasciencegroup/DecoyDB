...
if __name__ == '__main__':
    ...
    for repeat in range(repeats):
        ...
        # train_df = pd.read_csv(os.path.join(data_root, 'train2013.csv'))
        ...
        if pretrain==1:
            ...
            model.load_state_dict(torch.load("./model/20240925_022515_EGNN_repeat0_preinfonce/model/epoch-17, train_loss-6.8971, train_rmse-2.6262, valid_rmse-3825.7188, valid_pr-1.0000.pt"))
