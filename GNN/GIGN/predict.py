...
valid_dir = os.path.join(data_root, 'CSAR_process')
...
valid_df = pd.read_csv(os.path.join(data_root, 'CSAR_train.csv'))
...
load_model_dict(model, './model_samples/20241107_164707_GIGN_repeat4_vanilla/model/epoch-278, train_loss-0.1702, train_rmse-0.4126, valid_rmse-1.1985, valid_pr-0.7778.pt')
model = model.cuda()
